  ...
  Persistence2: {
    ...
    frag: GLSL`
        ...
        void main () {
            ...
            vec4 col=texture2D(t, vec2(uv.x*intensity.r,uv.y+intensity.g));
            gl_FragColor = col;
        }`,
  },
});
...
const Persistence = ({
  ...
  persistence: number;
}) => <Node shader={shaders.Persistence2} backbuffering uniforms={{t: children, bump, persistence}} />;

export class ExampleBump2 extends Component<{persistence: number}> {
  render() {
